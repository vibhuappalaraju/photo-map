...
class LocationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
       let place = results[indexPath.row] as! NSDictionary
       // let lat = place.
        
        let latitude = place.value(forKeyPath: "location.lat") as! NSNumber
       let longitude = place.value(forKeyPath: "location.lng") as! NSNumber
        delegate.locationsPickedLocation(controller: self,latitude: latitude,longitude: longitude)
    }
